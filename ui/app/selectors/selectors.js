...
//XXX
export function getCurrentCurrencySym (state) {
  return state.metamask.currentCurrencySymbol
}
...
//XXX
export function getCurrentCurrencySymbol (state) {
  return state.metamask.settings.ticker
}
