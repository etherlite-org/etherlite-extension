    ...
    return (
      <div className="metametrics-opt-in">
        <div className="metametrics-opt-in__main">
          ...
          <div className="metametrics-opt-in__title">Help Us Improve EtherLite Extension Wallet</div>
          <div className="metametrics-opt-in__body">
            <div className="metametrics-opt-in__description">
            EtherLite would like to gather usage data to better understand how our users interact with the extension. This data
             will be used to continually improve the usability and user experience of our product and the EtherLite ecosystem.
            </div>
            <div className="metametrics-opt-in__description">
            EtherLite will..
            </div>
