...
export default class SendAssetRow extends Component {
  static propTypes = {
    ...
    currentCurrencySymbol: PropTypes.string //XXX
  }
  ...
  renderEth (insideDropdown = false) {
    const { t } = this.context
    const { accounts, selectedAddress, currentCurrencySymbol } = this.props
    ...
    return (
      ...
      >
        ...
        <div className="send-v2__asset-dropdown__asset-data">
          {/* XXX */}
          <div className="send-v2__asset-dropdown__symbol">{currentCurrencySymbol}</div>
