    ...
    return (
      ...
      >
        ...
        <DropdownMenuItem
          key="etherlite"
          closeMenu={() => this.props.hideNetworkDropdown()}
          onClick={() => this.handleClick('etherlite')}
          style={{ ...dropdownMenuItemStyle, borderColor: '#038789' }}
        >
          {
            providerType === 'etherlite'
              ? <i className="fa fa-check" />
              : <div className="network-check__transparent">✓</div>
          }
          <NetworkDropdownIcon backgroundColor="#29B6AF" isSelected={providerType === 'mainnet'} />
        ...
        <DropdownMenuItem
          key="testlite"
          closeMenu={() => this.props.hideNetworkDropdown()}
          onClick={() => this.handleClick('testlite')}
          style={{ ...dropdownMenuItemStyle, borderColor: '#038789' }}
        >
          {
            providerType === 'testlite'
              ? <i className="fa fa-check" />
              : <div className="network-check__transparent">✓</div>
          }
          <NetworkDropdownIcon backgroundColor="rgb(255 74 141)" isSelected={providerType === 'testlite'} />
          <span
            className="network-name-item"
            style={{
              color: providerType === 'testlite'
                ? '#ffffff'
                : '#9b9b9b',
            }}
          >
