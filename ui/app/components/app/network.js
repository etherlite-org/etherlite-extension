  ...
  return (
    <div
      className={classnames('network-component pointer', {
        ...
        'ethereum-network': providerName === 'etherlite',
...
export default class Network extends Component {
  ...
  render () {
    ...
    switch (providerName) {
      ...
      case 'etherlite':
        return (
          <NetworkIndicator disabled={disabled} hoverText={'etherlite'} onClick={onClick} providerName={providerName}>
            <NetworkDropdownIcon
              backgroundColor="#038789"
              nonSelectBackgroundColor="#15afb2"
              loading={networkNumber === 'loading'}
            />
            <div className="network-name">{'EtherLite Mainnet'}</div>
          </NetworkIndicator>
        )

        case 'testlite':
          return (
            <NetworkIndicator disabled={disabled} hoverText={'testlite'} onClick={onClick} providerName={providerName}>
              <NetworkDropdownIcon
                backgroundColor="#038789"
                nonSelectBackgroundColor="#15afb2"
                loading={networkNumber === 'loading'}
              />
              <div className="network-name">{'TestLite'}</div>
            </NetworkIndicator>
          )
