...
//XXX
export function setCurrentCurrencySymbol(currency) {
  return async (dispatch) => {
    dispatch({
      type: actionConstants.SET_CURRENT_CURRENCY_SYMBOL,
      value: {
...
export function updateAndSetCustomRpc (newRpc, chainId, ticker = 'ETL', nickname, rpcPrefs) {
  return async (dispatch) => {
...
export function editRpc (oldRpc, newRpc, chainId, ticker = 'ETL', nickname, rpcPrefs) {
  return async (dispatch) => {
...
export function setRpcTarget (newRpc, chainId, ticker = 'ETL', nickname) {
  return async (dispatch) => {
